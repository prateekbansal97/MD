...
public:
    ...
    lj_list_cutoff2_(0.0), nCells_lj_(0), nCells_x_lj_(0),
    nCells_y_lj_(0), nCells_z_lj_(0), lcell_x_lj_(0.0),
    lcell_y_lj_(0.0), lcell_z_lj_(0.0),
    ee_cutoff2_(0.0), ee_list_cutoff_(0.0),
    ee_list_cutoff2_(0.0), nCells_ee_(0), nCells_x_ee_(0),
    nCells_y_ee_(0), nCells_z_ee_(0), lcell_x_ee_(0.0),
    lcell_y_ee_(0.0), lcell_z_ee_(0.0),
    natoms_(topology.get_nAtoms()) {init_forces();}

    [[nodiscard]] const Topology& get_topology() const { return topology_;}
