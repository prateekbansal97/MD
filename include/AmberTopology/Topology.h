...
namespace md
{
    ...
    public:
        ...
        [[nodiscard]] std::vector<Bonded::HarmonicUB>& get_harmonic_UBs() { return HarmonicUB_list_; }
        [[nodiscard]] std::vector<Bonded::HarmonicImproper>& get_harmonic_impropers() { return HarmonicIMP_list_; }
        [[nodiscard]] std::vector<Bonded::CMapGroup>& get_cmaps() { return CMapGroup_list_; }
    ...
    private:
        ...
        [[maybe_unused]] void print_atom_details(int max_print) const;
        [[maybe_unused]] void print_atom_details_to_file() const;
        ...
        std::vector<Bonded::HarmonicUB> HarmonicUB_list_;
        ...
        std::vector<Bonded::HarmonicImproper> HarmonicIMP_list_;
        ...
        std::vector<Bonded::HarmonicBond> HarmonicBond_list_;
        std::vector<int> bonds_without_h_;

        std::vector<int> angles_including_h_;
        std::vector<Bonded::HarmonicAngle> HarmonicAngle_list_;
        std::vector<int> angles_without_h_;

        std::vector<int> dihedrals_including_h_;
        std::vector<Bonded::CosineDihedral> CosineDihedral_list_;
        ...
        std::vector<Bonded::CMapGroup> CMapGroup_list_;
